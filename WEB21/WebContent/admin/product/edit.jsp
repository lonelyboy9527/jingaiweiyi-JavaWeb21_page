...
<HTML>
	<HEAD>
		...
		<script type="text/javascript">
			...
			/* // 页面加载完毕后，再去确定那个option被选中
			window.onload = function () {
				// 获得当前回显的 product 的 cid
				var cid = "${product.cid}";
				//获得所有<select name="cid">下的option
				var options = document.getElementById("cid").getElementsByTagName("option");
				//比较每一个optin的value和product的cid的比较
	...
	<body>
		<!--  -->
		<form id="userAction_save_do" name="Form1" action="${pageContext.request.contextPath}/adminProductUpdateProduct" method="post" >
